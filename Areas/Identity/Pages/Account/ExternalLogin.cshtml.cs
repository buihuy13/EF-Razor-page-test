...
namespace EFRazor.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            //Thông báo lỗi từ nhà cung cấp bên ngoài (facebook,google,microsoft,...)
            if (remoteError != null)
            {
                ErrorMessage = $"Error from external provider: {remoteError}";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
            //Lấy thông tin người dùng từ nhà cung cấp bên ngoài
            var info = await _signInManager.GetExternalLoginInfoAsync();
            //Nếu thông tin này = null thì trả về trang login
            if (info == null)
            {
            ...
            // Nếu thông tin người dùng có tồn tại thì đăng nhập vào trang web 
            ...
            else
            {
                ...
                if (info.Principal.HasClaim(c => c.Type == ClaimTypes.Email))
                {
                    ...
                    {
                        //Lấy email từ thông tin của dịch vụ ngoài
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Tạm thời hiểu Claim là đặc tính của 1 đối tượng
                if (info.Principal.HasClaim(c => c.Type ==ClaimTypes.Email))
                {
                ...
                {
                    if (externalUser.Id == registerUser.Id)
                    {
                        ...
                        {
                            ModelState.AddModelError(string.Empty, "Lỗi khi liên kết tài khoản");
                            return Page();
                        }
                    }
                    else
                ...
                if (externalUser!=null && registerUser==null)
                {
                    ModelState.AddModelError(string.Empty, "Tài khoản từ dịch vụ ngoài đã tồn tại và tài khoản vừa nhập không tồn tại");
                    return Page();
                }
                ...
                if (externalUser == null && externalEmail == Input.Email)
                {
                    ...
                    {
                        //Lien ket tai khoan ngoai voi user vua tao ra
